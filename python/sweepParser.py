...
class SweepAnalyzer(QtWidgets.QWidget):
    ...
    def __init__(self, port='/dev/tty.usbserial-14210', baudrate=115200):
        super().__init__()
    ...
    def parse_buffer(self):
        ...
        for line in self.buffer:
            if line.startswith("COARSE;"):
                ...
                self.coarseMaxFreq = int(freq) / 1000.0  # keep decimal precision
            elif line.startswith("FINE_MAX_RAW;"):
                _, adc, freq = line.split(";")
                self.fineMaxRawFreq = int(freq) / 1000.0  # keep decimal precision
    ...
    def plot_results(self):
        ...
        if self.coarseData:
            ...
            self.plotWidgetCoarse.plot(x, y, pen='y')
            self.add_vertical_line(self.plotWidgetCoarse, self.coarseMaxFreq, "red", "Max")
        ...
        if self.fineData:
            ...
            self.add_vertical_line(self.plotWidgetFine, self.fineMaxRawFreq, "r", "Max")
